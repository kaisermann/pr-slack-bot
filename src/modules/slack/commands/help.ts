import { EMOJIS, PR_SIZES } from '../../../consts'
...
function formatHelpSection(items, title) {
  return `*${title}*:\n${items
...
export default () =>
  [
    formatHelpSection(commands, 'Available commands'),
    formatHelpSection(utils, 'Utilities'),
    formatHelpSection(emojis, 'Emojis'),
  ].join('\n\n\n')
